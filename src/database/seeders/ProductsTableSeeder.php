...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $seasons = DB::table('seasons')->get()->keyBy('name');
        ...
        foreach ($products as $product) {
            if (isset($relations[$product->name])) {
                foreach ($relations[$product->name] as $seasonName) {
                    if (isset($seasons[$seasonName])) {
                        DB::table('product_season')->insert([
                            'product_id' => $product->id,
                            'season_id' => $seasons[$seasonName]->id,
                        ]);
                    }
                }
            }
